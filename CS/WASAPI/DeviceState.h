...
namespace winrt::WASAPI::implementation
{
    ...
    struct DeviceStateSourceT
    {
        ...
        event_token DeviceStateChanged(Windows::Foundation::TypedEventHandler<IDeviceStateSource, WASAPI::DeviceStateChangedEventArgs> const& handler)
        {
    ...
    protected:
        ...
        event<Windows::Foundation::TypedEventHandler<IDeviceStateSource, WASAPI::DeviceStateChangedEventArgs>> m_deviceStateChanged;
