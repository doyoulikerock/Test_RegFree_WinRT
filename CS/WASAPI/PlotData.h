...
namespace winrt::WASAPI::implementation
{
    ...
    {
        event_token PlotDataReady(Windows::Foundation::TypedEventHandler<IPlotDataSource, WASAPI::PlotDataReadyEventArgs> const& handler)
        {
    ...
    protected:
        event<Windows::Foundation::TypedEventHandler<IPlotDataSource, WASAPI::PlotDataReadyEventArgs>> m_plotDataReady;
